...
class Blog {
    ...
    <div class="uk-card-footer uk-clearfix">
        <div class="uk-float-left">
            <span class="uk-label uk-label-success uk-border-pill">${category}</span>
        </div>
        <div class="uk-float-right">
            <a href="${this.sanitizePath}/${link}" class="uk-button uk-button-text uk-text-primary">Read more</a>
        </div>
    </div>
</article>`
    }
