...
<head>
    <?php echo view("partials/title-meta", array("title" => "Sellers List")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <?php echo view("partials/topbar", array("title" => "Sellers List")) ?>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-1.jpg" alt="avatar-1" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-3.jpg" alt="avatar-3" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-5.jpg" alt="avatar-5" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-6.jpg" alt="avatar-6" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-7.jpg" alt="avatar-7" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-8.jpg" alt="avatar-8" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-9.jpg" alt="avatar-9" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <img src="/images/users/avatar-10.jpg" alt="avatar-10" class="img-fluid avatar-sm rounded-circle avatar-border me-1" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-1.jpg" alt="avatar-1" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-3.jpg" alt="avatar-3" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-5.jpg" alt="avatar-5" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-6.jpg" alt="avatar-6" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-7.jpg" alt="avatar-7" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-8.jpg" alt="avatar-8" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-9.jpg" alt="avatar-9" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <a href="javascript:void(0);">
                                                <img src="/images/users/avatar-10.jpg" alt="avatar-10" class="img-fluid img-thumbnail avatar-xxl rounded-circle avatar-border" />
                                            </a>
                                        </div>
                                        <div class="text-center">
