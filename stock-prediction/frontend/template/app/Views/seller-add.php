...
<head>
     <?php echo view("partials/title-meta", array("title" => "Seller Add")) ?>
...
<body>
     ...
     <div class="wrapper">
          ...
          <?php echo view("partials/topbar", array("title" => "Seller Add")) ?>
     ...
     <script src="/js/pages/app-ecommerce-seller-add.js"></script>
