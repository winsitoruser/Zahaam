...
<head>
    <?php echo view("partials/title-meta", array("title" => "Product Edit")) ?>
...
<div class="wrapper">
    ...
    <?php echo view("partials/topbar", array("title" => "Product Edit")) ?>
...
<!-- Page Js -->
<script src="/js/pages/ecommerce-product-details.js"></script>
